...
<div class="mc-field-group">
    ...
    <div class="clear"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div> <p>You may unsubscribe at any time.</p>
    </div>
</form>
</div>
	...
	<div class="row">
		...
		<div>
			<div>
				...
				<p>Bill Locke reviews a new, award-winning documentary about a pastor and his wife, who take in babies that no one else wants.</p>
		...
		<div>
			<div>
				...
				<p>This issue is about “power beyond words” – the connections and hidden truths that are revealed through experience.</p>
...
<div id="writers">
	<div class="writers-column-1">
		...
		<div>
			...
			<p>Take a look at the winners of our Spring 2015 Kolbe Times Photo Contest!</p>
		</div>
	</div> <!-- writers-column -->
	<div class="writers-column-2">
		<div>
			...
			<p>By Rainer Maria Rilke (1875-1926), one of the most enigmatic and significant poets of the last century.</p>
		</div>
	</div> <!-- writers-column -->
</div> <!-- writers -->
		</section><!-- #container -->
